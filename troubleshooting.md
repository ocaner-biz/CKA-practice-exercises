...
For our deployment done in [Cluster Architecture, Installation & Configuration](https://github.com/ocaner-biz/CKA-practice-exercises/blob/CKA-v1.29/cluster-architecture-installation-configuration.md) here is how to get logs.
